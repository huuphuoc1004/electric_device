                        ...
                        <li>
                            <div class="progress-container progress-primary">
                                ...
                                <ul class="list-unstyled team-info">
                                    ...
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar2.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar3.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar4.jpg") }} alt="Avatar">
                                    </li>                            
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="progress-container">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar10.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar9.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar8.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar7.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar6.jpg") }} alt="Avatar">
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="progress-container progress-warning">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar5.jpg") }} alt="Avatar">
                                    </li>
                                    <li>
                                        <img src={{ asset("css/admin/images/xs/avatar2.jpg") }} alt="Avatar">
                                    </li>
...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{ route('admin.index') }}"><img src="{{ asset('css/admin/images/logo.svg') }}" width="25" alt="Aero"><span class="m-l-10">Electronic</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info"> 
                    <a class="image" href=""><img src={{ asset("css/admin/images/admin-hp.jpg") }} style="width: 74px; height: 74px;" alt="User"></a>
                    <div class="detail">
                        <h4>Hữu Phước</h4>
                        <small>Admin</small>                        
                    </div>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-lock"></i><span>Authentication</span></a>
                <ul class="ml-menu">
                    <li><a href="{{ route('auth.sign_in_admin') }}">Sign In</a></li>
                    <li><a href="{{ route('auth.sign_up_admin') }}">Sign Up</a></li>
                    <li><a href="{{ route('auth.forgot_password') }}">Forgot Password</a></li>
                ...
                <div class="card">
                    <ul class="list-unstyled">
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src={{ asset("css/admin/images/xs/avatar4.jpg") }} alt="">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src={{ asset("css/admin/images/xs/avatar5.jpg") }} alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src={{ asset("css/admin/images/xs/avatar2.jpg") }} alt="">
                                    <div class="media-body">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src={{ asset("css/admin/images/xs/avatar1.jpg") }} alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:vosid(0);">
                                <div class="media">
                                    <img class="media-object " src={{ asset("css/admin/images/xs/avatar3.jpg") }}s alt="">
                                    <div class="media-body">
